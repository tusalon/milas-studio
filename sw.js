...
const urlsToCache = [
  ...
  '/milas-studio/vendor/react.production.min.js',
  '/milas-studio/vendor/react-dom.production.min.js',
  '/milas-studio/vendor/babel.min.js',
  '/milas-studio/vendor/bcrypt.min.js',
  '/milas-studio/vendor/tailwind-browser.js',
  '/milas-studio/vendor/lucide/lucide.css',
  '/milas-studio/vendor/lucide/lucide.woff2',
  '/milas-studio/utils/push-config.js',
  '/milas-studio/utils/push-notifications.js'
];
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/milas-studio/icons/icon-192x192.png',
    badge: '/milas-studio/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/milas-studio/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/milas-studio/admin.html';
  event.waitUntil(
